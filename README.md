...
| **[F1 Streetwear](https://github.com/sasankreddyvenna/F1-inspired-streetwear-brand)**<br>[live&nbsp;site](https://f1-inspired-streetwear-brand.vercel.app) | Storefront UI — catalogue, live search filtering with an empty state, and a cart with quantity adjustment. | React · TypeScript · Tailwind |
